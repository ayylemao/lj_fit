...
crd_path_file=crd/crd_names.dat # CHANGE THIS IF NEEDED
ref_file=data/5conf_tip3.dat # CHANGE THIS!
opt_file=def_params/opt_species.dat
one_four_species=def_params/one_four_species.dat
nfiles=416 # CHANGE IF NEEDED
num_pep_atoms=34
n_onefour=5
ngenerations=200000
l_bound=0.1
...
OUTFOLDER=multi_fit/5conf_tip3
mkdir -p $OUTFOLDER
